...
<html lang="en">
  <head>
	...
	<script src="/xinxinDiningRoom/js/jquery-1.7.2.min.js" type="text/javascript"></script>
  ...
  <!--<![endif]-->
   ...
   <div class="content">
        ...
        <div class="container-fluid">
         ...
         <form id="tab" action="/xinxinDiningRoom/home.do?flag=updUser" method="post">               
    ...
    <form id="tab2" action="/xinxinDiningRoom/home.do?flag=updUserPwd" method="post">
